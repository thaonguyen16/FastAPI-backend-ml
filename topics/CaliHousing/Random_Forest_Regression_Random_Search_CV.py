...
def store_model(model, model_name = ""):
    ...
    joblib.dump(model,'topics/CaliHousing/models/' + model_name + '_RandomSearch_CV' + '_model.pkl')
def load_model(model_name):
    # Load objects into memory
    #del model
    model = joblib.load('topics/CaliHousing/models/' + model_name + '_RandomSearch_CV' + '_model.pkl')
    #print(model)
    return model
